  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      await logAdminActivity({
        ...
        module: "Questions",
        description: `Deleted question from chapter "${questionToDelete?.chapter}"`,
        targetId: id,
        targetType: "question",
      });
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex justify-center mb-6">
            <div className="bg-white rounded-2xl shadow-xl px-8 py-6 flex flex-col items-center">
              ...
              <p className="text-4xl font-black bg-linear-to-r from-pink-600 to-indigo-800 bg-clip-text text-transparent">
                {totalQuestionsForChapter}
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-evenly gap-4 mb-6 flex-wrap">
            <Menu
              as="div"
              className="relative inline-block text-left w-full md:w-1/3"
            >
                ...
                <div className="px-2 py-2 ">
                  ...
                  {chapters
                    .filter((ch) =>
                      ch
                        .toLowerCase()
                        .includes(chapterSearchTerm.toLowerCase()),
                    )
                    .map((ch) => {
              ...
              {filteredQuestions.map((q, idx) => (
                ...
                >
                  ...
                  <p className="mt-3 font-semibold flex items-center justify-center gap-2 text-green-600">
                    <CheckCircleIcon /> Correct Answer: English:{" "}
                    {q.correct_answer} | Tamil: {q.correct_answer_ta}
                  </p>
